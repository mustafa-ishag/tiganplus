<?php
/**
 * صفحة تأكيد تحديث SAP للمستخلصات النهائية العادية
 * Confirm SAP Update for Final Regular Extracts
 */
...
try {
    $updateStmt = $db->prepare("UPDATE final_regular_extracts SET entry_sheet_number = ?, po_number = ?, disbursed_date = ? WHERE id = ?");
