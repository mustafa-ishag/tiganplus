                        ...
                        <div class="col mr-2">
                            ...
                            <div class="mt-2">
                                <div class="text-xs text-muted">
                                    ...
                                    صافي: <span class="font-weight-bold text-primary"><?php echo number_format($stats['net_amount'] ?? 0, 0); ?></span>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="approvalStageFilter" multiple>
                        <?php foreach ($approvalStages as $stage): ?>
                            <option value="<?php echo $stage['key'] ?? ''; ?>"><?php echo htmlspecialchars($stage['name']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-3">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($extract['total_penalty_amount'] > 0): ?>
                                    <span class="text-danger"><?php echo number_format($extract['total_penalty_amount'], 2); ?></span>
                                    <span class="sar-icon"><svg><use href="#sar-symbol"/></svg></span>
                                <?php else: ?>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <button type="button" class="btn btn-sm btn-outline-success" onclick="viewExtract(<?php echo $extract['id']; ?>)" title="عرض">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <a href="export-invoice.php?id=<?php echo $extract['id']; ?>" class="btn btn-sm btn-outline-info" target="_blank" title="تصدير كفاتورة ضريبية">
